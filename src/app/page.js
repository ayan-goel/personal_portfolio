        ...
        >
          <div className="w-full md:w-3/5 order-2 md:order-1 space-y-8">
            <div className="space-y-4 animate-fade-in">
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-normal tracking-tight leading-[1.8] pb-5">
                Hi, I&#39;m <span className="text-gradient bg-gradient-to-r from-white via-neutral-300 to-neutral-400 bg-clip-text text-transparent inline-block pb-2">Ayan.</span>
              </h1>
              
              <h2 className="text-2xl md:text-3xl font-medium text-neutral-300 mt-6">
                I&#39;m a <TypingAnimation texts={roles} />
              </h2>
            </div>
            
            <p className="text-lg md:text-xl text-neutral-400 max-w-xl leading-relaxed font-light animate-fade-in animate-delay-200">
            ...
            <div className="flex flex-wrap gap-5 pt-6 items-center animate-fade-in animate-delay-400">
              ...
              >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-neutral-500 to-neutral-400 rounded-full opacity-0 group-hover:opacity-70 blur-sm transition duration-300 group-hover:duration-200"></div>
                <div className="relative flex items-center justify-center bg-neutral-900 p-4 rounded-full shadow-sm group-hover:shadow-md border border-neutral-700 z-10">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-neutral-300 group-hover:text-white transition duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-neutral-500 to-neutral-400 rounded-full opacity-0 group-hover:opacity-70 blur-sm transition duration-300 group-hover:duration-200"></div>
                <div className="relative flex items-center justify-center bg-neutral-900 p-4 rounded-full shadow-sm group-hover:shadow-md border border-neutral-700 z-10">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-neutral-300 group-hover:text-white transition duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button 
                ...
                className="pl-4 hidden md:inline-flex items-center gap-2 text-neutral-400 hover:text-white transition duration-300"
              >
                Learn more
          ...
          <div className="w-full md:w-2/5 order-1 md:order-2 flex justify-center mb-8 md:mb-0 animate-fade-in animate-delay-300">
            <div className="relative h-80 w-80 md:h-[26rem] md:w-[26rem]">
              {/* Subtle glow behind image - grey tones */}
              <div className="absolute -z-10 -inset-4 rounded-full bg-gradient-to-br from-neutral-600/20 to-neutral-700/15 blur-2xl"></div>
              ...
              <div className="relative h-full w-full">
                <div className="absolute inset-0 rounded-full overflow-hidden">
                  ...
                  <div className="h-full w-full flex items-center justify-center">
                    <span className="text-lg font-light text-neutral-500">Profile Photo</span>
                    <Image 
                      src="/images/pfp6.JPG" 
                      alt="Ayan Goel" 
                      fill
            ...
            <div className="w-full lg:w-1/2" ref={sectionRefs.about} id="about">
              <div className="mb-10 animate-fade-in" style={{ animationDelay: '0.5s' }}>
                <div className="inline-block">
                  <h2 className="relative text-4xl md:text-5xl font-bold text-gradient bg-gradient-to-r from-white to-neutral-400 bg-clip-text text-transparent">
                    About Me
                    <div className="absolute -bottom-4 left-0 w-full h-1 bg-gradient-to-r from-neutral-400 to-neutral-600 rounded-full transform origin-left"></div>
                  </h2>
                </div>
              </div>
              ...
              <div className="group relative transition duration-500">
                ...
                <div className="relative bg-neutral-900/90 backdrop-blur-sm rounded-2xl overflow-hidden transform transition-all duration-500 group-hover:translate-y-[-5px] border border-neutral-700">
                  <div className="p-5 md:p-6">
                    ...
                    <div className="mb-6">
                      <h3 className="text-lg font-bold mb-3 text-white">Programming Languages</h3>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-6 gap-3">
                        ...
                        <div className="group/icon flex flex-col items-center justify-center">
                          <div className="relative w-14 h-14 flex items-center justify-center bg-neutral-800 rounded-xl shadow-sm transition duration-300 group-hover/icon:shadow-md overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-neutral-600/30 to-neutral-500/30 opacity-50 group-hover/icon:opacity-100 transition-opacity duration-300"></div>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg" alt="Next.js" className="w-8 h-8 invert relative z-10" />
                            <div className="absolute inset-0 bg-black/70 text-white flex items-center justify-center rounded-xl opacity-0 group-hover/icon:opacity-100 transition-opacity duration-300 z-20">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-6 gap-3">
                        ...
                        <div className="group/icon flex flex-col items-center justify-center">
                          <div className="relative w-14 h-14 flex items-center justify-center bg-neutral-800 rounded-xl shadow-sm transition duration-300 group-hover/icon:shadow-md overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-neutral-600/30 to-neutral-500/30 opacity-50 group-hover/icon:opacity-100 transition-opacity duration-300"></div>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg" alt="Express.js" className="w-8 h-8 invert relative z-10" />
                            <div className="absolute inset-0 bg-black/70 text-white flex items-center justify-center rounded-xl opacity-0 group-hover/icon:opacity-100 transition-opacity duration-300 z-20">
                        ...
                        <div className="group/icon flex flex-col items-center justify-center">
                          <div className="relative w-14 h-14 flex items-center justify-center bg-neutral-800 rounded-xl shadow-sm transition duration-300 group-hover/icon:shadow-md overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-neutral-600/30 to-neutral-500/30 opacity-50 group-hover/icon:opacity-100 transition-opacity duration-300"></div>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/flask/flask-original.svg" alt="Flask" className="w-8 h-8 invert relative z-10" />
                            <div className="absolute inset-0 bg-black/70 text-white flex items-center justify-center rounded-xl opacity-0 group-hover/icon:opacity-100 transition-opacity duration-300 z-20">
                        ...
                        <div className="group/icon flex flex-col items-center justify-center">
                          <div className="relative w-14 h-14 flex items-center justify-center bg-neutral-800 rounded-xl shadow-sm transition duration-300 group-hover/icon:shadow-md overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-neutral-600/30 to-neutral-500/30 opacity-50 group-hover/icon:opacity-100 transition-opacity duration-300"></div>
                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 fill-current text-white relative z-10">
                    ...
                    {/* Cloud & DevOps */}
                    <div>
                      <h3 className="text-lg font-bold mb-3 text-white">Cloud & DevOps</h3>
                      <div className="grid grid-cols-6 gap-3">
                        {/* AWS */}
                        <div className="group/icon flex flex-col items-center justify-center">
                          <div className="relative w-14 h-14 flex items-center justify-center bg-neutral-800 rounded-xl shadow-sm transition duration-300 group-hover/icon:shadow-md overflow-hidden">
          ...
          <div className="relative bg-neutral-900/90 backdrop-blur-sm rounded-2xl overflow-hidden transform transition-all duration-500 group-hover:translate-y-[-5px] border border-neutral-700">
            <div className="p-8 md:p-10">
              <div className="relative max-w-4xl mx-auto text-center">
                <svg className="w-16 h-16 mx-auto mb-8 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm3.293 1.293a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414L7.586 10 5.293 7.707a1 1 0 010-1.414zM11 12a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
                </svg>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-gradient bg-gradient-to-r from-white to-neutral-400 bg-clip-text text-transparent leading-tight tracking-tight pb-2">Let&#39;s Work Together.</h2>
                ...
                <div className="flex flex-wrap justify-center gap-6">
                  ...
                  >
                    ...
                    <span className="relative inline-flex items-center gap-2 bg-white group-hover:bg-neutral-100 transition-colors duration-300 text-black px-8 py-4 rounded-full shadow-md hover:shadow-lg z-10 font-medium">
                      Browse Projects
                  ...
                  <Link 
                    ...
                    className="group relative"
                  >
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-neutral-400 to-white rounded-full opacity-80 group-hover:opacity-100 blur-sm transition duration-300 group-hover:duration-200"></div>
                    <span className="relative inline-flex items-center gap-2 bg-neutral-800 border border-neutral-600 group-hover:bg-neutral-700 transition-colors duration-300 text-white px-8 py-4 rounded-full shadow-md hover:shadow-lg z-10 font-medium">
                      View Experience
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                      </svg>
