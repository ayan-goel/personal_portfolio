    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-16 md:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <div key={index} className="group relative transition duration-500 h-full">
            ...
            <div className="relative bg-white/90 dark:bg-secondary-800/90 backdrop-blur-sm rounded-2xl overflow-hidden transform transition-all duration-500 group-hover:translate-y-[-5px] group-hover:shadow-xl border border-gray-100 dark:border-secondary-700 h-full flex flex-col">
              ...
              <div className="p-6 md:p-8 flex-grow">
                <h3 className="text-xl md:text-2xl font-bold text-primary-600 dark:text-primary-400 group-hover:text-primary-500 dark:group-hover:text-primary-300 transition-colors duration-300 mb-3">{project.title}</h3>
          ...
          <div className="relative bg-white/90 dark:bg-secondary-800/90 backdrop-blur-sm rounded-2xl overflow-hidden transform transition-all duration-500 group-hover:translate-y-[-5px] group-hover:shadow-xl border border-gray-100 dark:border-secondary-700">
            <div className="p-6 md:p-8">
              <ul className="space-y-8">
                <li className="border-b border-gray-200 dark:border-gray-700 pb-6 group/item">
                  <h3 className="font-bold text-xl text-primary-600 dark:text-primary-400 mb-3 group-hover/item:text-primary-500 dark:group-hover/item:text-primary-300 transition-colors duration-300">MediSense AI</h3>
                  <p className="text-secondary-600 dark:text-gray-300 mb-4">
                  Engineered a full-stack web application that helps patients easily find diagnoses for conditions based on symptoms. Tuned Google BERT LLM predicting
                   prognoses with 91% accuracy across 150+ trials with 50,000+ medical reports. Trained Logistic Regression & Random Forest models assessing risk factors with 83% accuracy on 560,000+ rows.
                  </p>
                  <div className="flex flex-wrap items-center justify-between">
                    <div className="flex flex-wrap gap-2 mt-3">
                      {["Python", "Scikit-learn", "Google BERT LLM", "NumPy", "Pandas", "Streamlit"].map((tech, idx) => (
                        <span 
                          key={idx}
                          className="px-3 py-1 bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 text-sm rounded-full border border-primary-100 dark:border-primary-800 hover:bg-primary-100 dark:hover:bg-primary-800/40 transition-colors duration-300"
                        >
                    ...
                    <a 
                      href="https://github.com/ayan-goel/HackGT11" 
                      target="_blank" 
                      rel="noopener noreferrer"
                ...
                <li className="border-b border-gray-200 dark:border-gray-700 pb-6 group/item">
                  <h3 className="font-bold text-xl text-primary-600 dark:text-primary-400 mb-3 group-hover/item:text-primary-500 dark:group-hover/item:text-primary-300 transition-colors duration-300">Premier Leauge Betting Assistant</h3>
                  <p className="text-secondary-600 dark:text-gray-300 mb-4">
                    Created dashboard to help Premier League bettors make more informed decisions. 
                    Applied Selenium to webscrape data from DraftKings, Bet365, and Pinnacle to compare real-time PL match odds and find arbitrage opportunities.
                    Calculated the percentage chance of bets to hit with scraped data and used D3.js to visualize the data.
                  </p>
                  <div className="flex flex-wrap items-center justify-between">
                    <div className="flex flex-wrap gap-2 mt-3">
                      {["Python", "Selenium", "D3.js", "NumPy", "Pandas"].map((tech, idx) => (
                        <span 
                          key={idx}
                          className="px-3 py-1 bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 text-sm rounded-full border border-primary-100 dark:border-primary-800 hover:bg-primary-100 dark:hover:bg-primary-800/40 transition-colors duration-300"
                        >
                    ...
                    <a 
                      href="https://github.com/ayan-goel/soccer-betting-analysis" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-3 px-4 py-2 bg-gray-100 text-secondary-700 dark:bg-secondary-700 dark:text-white text-sm rounded-full shadow-sm hover:shadow-md border border-gray-200 dark:border-secondary-600 hover:bg-gray-200 dark:hover:bg-secondary-600 transition-all duration-300 font-medium"
                    >
                ...
                <li className="group/item">
                  <h3 className="font-bold text-xl text-primary-600 dark:text-primary-400 mb-3 group-hover/item:text-primary-500 dark:group-hover/item:text-primary-300 transition-colors duration-300">Movies Store Application</h3>
                  <p className="text-secondary-600 dark:text-gray-300 mb-4">
                    Website that allows users to view, explore, and buy movies while creating and reading user reviews.
                  </p>
                  <div className="flex flex-wrap items-center justify-between">
                    <div className="flex flex-wrap gap-2 mt-3">
                      {["Django", "Python", "SQLite", "HTML", "CSS"].map((tech, idx) => (
                        <span 
                          key={idx}
                          className="px-3 py-1 bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 text-sm rounded-full border border-primary-100 dark:border-primary-800 hover:bg-primary-100 dark:hover:bg-primary-800/40 transition-colors duration-300"
                        >
                    ...
                    <a 
                      href="https://github.com/ayan-goel/VAASA" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-3 px-4 py-2 bg-gray-100 text-secondary-700 dark:bg-secondary-700 dark:text-white text-sm rounded-full shadow-sm hover:shadow-md border border-gray-200 dark:border-secondary-600 hover:bg-gray-200 dark:hover:bg-secondary-600 transition-all duration-300 font-medium"
                    >
                ...
                <li className="group/item">
                  <h3 className="font-bold text-xl text-primary-600 dark:text-primary-400 mb-3 group-hover/item:text-primary-500 dark:group-hover/item:text-primary-300 transition-colors duration-300">Personal Portfolio</h3>
                  <p className="text-secondary-600 dark:text-gray-300 mb-4">
                    This very website you are on right now.
                  </p>
                  <div className="flex flex-wrap items-center justify-between">
                    <div className="flex flex-wrap gap-2 mt-3">
                      {["React", "SVG", "D3.js"].map((tech, idx) => (
                        <span 
                          key={idx}
                          className="px-3 py-1 bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 text-sm rounded-full border border-primary-100 dark:border-primary-800 hover:bg-primary-100 dark:hover:bg-primary-800/40 transition-colors duration-300"
                        >
                    ...
                    <a 
                      href="https://github.com/ayan-goel/personal_portfolio" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-3 px-4 py-2 bg-gray-100 text-secondary-700 dark:bg-secondary-700 dark:text-white text-sm rounded-full shadow-sm hover:shadow-md border border-gray-200 dark:border-secondary-600 hover:bg-gray-200 dark:hover:bg-secondary-600 transition-all duration-300 font-medium"
                    >
